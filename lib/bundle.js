...
class Game {
  ...
  createMissiles(num){
    ...
    // = leftMissiles.concat(rightMissiles)
    return this.missiles = [new __WEBPACK_IMPORTED_MODULE_1__missile__["a" /* default */](this.ctx, 300, 90, 4 ), new __WEBPACK_IMPORTED_MODULE_1__missile__["a" /* default */](this.ctx, 295, 90, 4 ), new __WEBPACK_IMPORTED_MODULE_1__missile__["a" /* default */](this.ctx, 290, 90, 1 )]
  }
