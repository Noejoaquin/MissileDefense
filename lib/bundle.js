...
class Game {
  ...
  createMissiles(num){
    ...
    // }
    return this.missiles = [new __WEBPACK_IMPORTED_MODULE_1__missile__["a" /* default */](this.ctx, 200, 90, 4 )]// new Missile(this.ctx, 295, 90, 1 ), new Missile(this.ctx, 290, 90, 1 )]
  }
