...
class Bullet {
  constructor(ctx, xPos, yPos, xEnd, yEnd){
    // this.explosionXPos = xPos - 30;
    // this.explosionYPos = yPos - 30;
    this.xPos = xPos;
    this.yPos= yPos;
    this.xEnd = xEnd;
    this.yEnd = yEnd;
  ...
  draw() {
    ...
    if (!this.collided && !this.exploded){
      ...
      // this.ctx.beginPath();
      // this.ctx.fillStyle = this.color
      // this.ctx.fillRect(this.x,this.y, 35, 35)
      // this.ctx.closePath();
