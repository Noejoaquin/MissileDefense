...
class Game {
  ...
  makeBullets(){
    var bullet = new __WEBPACK_IMPORTED_MODULE_0__bullet__["a" /* default */](this.ctx, 20, 430, 90)
  ...
  createBase() {
    ...
    this.gunner1.draw()
      ...
      this.gunner2 = new __WEBPACK_IMPORTED_MODULE_2__gunner__["a" /* default */](300, 447, 10, this.ctx)
      this.gunner2.draw()
      //
