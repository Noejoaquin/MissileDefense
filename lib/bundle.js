...
class Game {
  ...
  mute(){
    let allObjects = this.missiles.concat(this.cities).concat(this.bullets).concat(this.gunner1)//.concat(this.explodedObjects)
    debugger
  ...
  unmute(){
    let allObjects = this.missiles.concat(this.cities).concat(this.bullets)//.concat(this.explodedObjects)
    debugger
  ...
  createMissiles(num){
    ...
    return this.missiles //= [new Missile(this.ctx, 200, 90, 4 )]// new Missile(this.ctx, 295, 90, 1 ), new Missile(this.ctx, 290, 90, 1 )]
  }
